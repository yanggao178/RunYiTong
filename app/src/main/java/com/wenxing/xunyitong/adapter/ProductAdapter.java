package com.wenxing.xunyitong.adapter;
...
import com.wenxing.xunyitong.activity.PharmacyProductsActivity;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        View.OnClickListener enterPharmacyClickListener = v -> {
            try {
                ...
                try {
                    Class.forName("com.wenxing.xunyitong.activity.PharmacyProductsActivity");
