...
import com.wenteng.frontend_android.adapter.AppointmentAdapter;
...
import com.wenteng.frontend_android.api.AppointmentListResponse;
...
public class MyAppointmentsActivity extends AppCompatActivity {
    ...
    private void loadAppointments() {
        ...
        // 调用API获取预约数据
        Call<ApiResponse<AppointmentListResponse>> call = ApiClient.getApiService()
                .getUserAppointments(userId, 0, 20);
    ...
    private int getCurrentUserId() {
        // TODO: 从SharedPreferences或其他地方获取当前用户ID
        // 这里返回-1表示未登录
        return -1;
    }
